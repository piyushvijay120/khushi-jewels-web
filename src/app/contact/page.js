...
export default function Contact() {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      label: 'Address',
      value: CONTACT_CONFIG.addressOneLine,
      sub: 'Mon – Sat: 10 AM – 10 PM  |  Sunday: Closed',
    },
    {
      icon: <svg style={{ width: '18px', height: '18px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>,
      label: 'Owners',
      value: CONTACT_CONFIG.owners.map(o => o.name).join('  &  '),
      sub: CONTACT_CONFIG.businessName + ' — Manufacturer & Wholesaler, Jaipur',
    },
  ];
